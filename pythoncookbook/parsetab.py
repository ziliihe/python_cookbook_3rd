...
_lr_productions = [
  ...
  ('expr -> expr PLUS term','expr',3,'p_expr','01.py',30),
  ('expr -> expr MINUS term','expr',3,'p_expr','01.py',31),
  ('expr -> term','expr',1,'p_expr_term','01.py',40),
  ('term -> term TIMES factor','term',3,'p_term','01.py',47),
  ('term -> term DIVIDE factor','term',3,'p_term','01.py',48),
  ('term -> factor','term',1,'p_term_factor','01.py',58),
  ('factor -> NUM','factor',1,'p_factor','01.py',64),
  ('factor -> LPAREN expr RPAREN','factor',3,'p_factor_group','01.py',70),
]
